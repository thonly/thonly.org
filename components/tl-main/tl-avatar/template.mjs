...
// Reference: https://codepen.io/jeanoliveira/pen/ObWYmY?editors=0110

template.innerHTML = `
    <link rel="stylesheet" href="components/tl-main/tl-avatar/shadow.css">
        <svg id="Camada_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" x="0px" y="0px" viewbox="0 0 251.5 430.6" enable-background="new 0 0 251.5 430.6" xml:space="preserve">
      <g id="camisacostas">
